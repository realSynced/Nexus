        ...
        <div className={``}>
            ...
            <div className="text-2xl pb-4">
                <form action="">
                    ...
                    <input type="text" placeholder="web development" className="px-2 border rounded-lg" />
                </form>
            </div>
            
            <div className="h-[28rem] overflow-y-auto">
                <div className="pb-12 grid grid-cols-4 gap-4 border-2 border-x-0 border-b-0 border-t-neutral-100 pt-4">
